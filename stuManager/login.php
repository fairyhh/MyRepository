...
<body>
	<!-- action 提交地址-->
    <form id="form1" runat="server" action="action.php?action=login" method="post">
    <div class="Main">
        <ul>
            <li class="top"></li>
            <li class="top2"></li>
            ...
            <li class="middle_B"></li>
             ...
             <li class="middle_C"><span class="btn"><input name="" type="submit" value="登录" /></span>
            <a href="register.php"><span class="register"><input name="" type="button" value="注册" /></a></li>
